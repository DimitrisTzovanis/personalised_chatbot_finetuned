...
class Args():
    def __init__(self):
        ...
        self.model_name_or_path = 'lighteternal/gpt2-finetuned-greek'
        self.config_name = 'lighteternal/gpt2-finetuned-greek'
        self.tokenizer_name = 'lighteternal/gpt2-finetuned-greek'
...
with open("/content/train_data.json", "r", encoding="utf-8") as f_train:
    train_data = json.load(f_train)
f_train.close()
# print(len(train_data))


with open("/content/train_data.json", "r", encoding="utf-8") as f_validate:
